...
public class Main extends Application {
    ...
    public void start(Stage primaryStageForTheCalculatorProgram) throws Exception {
        ...
        entryButtonOfAutoLoanCalculator.setOnAction(event3 -> {
            ...
            TopicAutoLoanTopic.setFont(Font.font("Times New Roman", FontWeight.BOLD, 42));
            ...
            textFieldLoanForPayment.setFont(Font.font("Times New Roman", FontWeight.BOLD, 19));
            ...
            textFieldLoanForTerm.setFont(Font.font("Times New Roman", FontWeight.BOLD, 19));
            ...
            textFieldLoanForRate.setFont(Font.font("Times New Roman", FontWeight.BOLD, 19));
